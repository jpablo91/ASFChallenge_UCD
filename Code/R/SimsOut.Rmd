...
PlotMap = function(info) {
  ggplot(info) +
  geom_sf(aes(fill = Epidemic), color = "slategrey") +
  geom_sf(data = st_centroid(subset(Hx, !is.na(cases))), color = "tomato") +
  theme_void() +
...
Hx_sim03 <- ReadSims(dir = here("Data/Period_1/Sims/S02/Agents/"))
