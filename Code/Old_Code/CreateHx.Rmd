...
Now we will use a function to join the hexagons with the administrative areas based on the amount of overlapping, we will use a treshold of 30%. This means that if there is >30% overlap the hexagon will join with the administrative area.  
